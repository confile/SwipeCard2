...
import de.majestella.serviceDetails.ServiceDetailsActivity;
...
//          arrayAdapter = new ServiceCardDtoListAdapter(MyActivity.this, R.layout.service_card, serviceCardDtos);
...
//        arrayAdapter = new ArrayAdapter<>(this, R.layout.service_card, R.id.helloText, serviceCardDtos);
...
//              Log.d("LIST", "**********************onFlingTopView offset: "+offset);
                ...
                view.findViewById(R.id.swipe_card_nope_indicator).setAlpha(offset < 0 ? -offset + 0.22f : 0);
                view.findViewById(R.id.swipe_card_liked_indicator).setAlpha(offset > 0 ? offset + 0.22f : 0);
...
//                nopeButton.setColorFilter(getColorByOffset(-offset, initColor, nopeTargetColor));
                nopeButton.getBackground().setColorFilter(getColorByOffset(-offset, initColor, nopeTargetColor), PorterDuff.Mode.SRC_ATOP);
...
//                likedButton.setColorFilter(getColorByOffset(offset, initColor, likedTargetColor));
                likedButton.getBackground().setColorFilter(getColorByOffset(offset, initColor, likedTargetColor), PorterDuff.Mode.SRC_ATOP);
...
//                makeToast(MyActivity.this, "Clicked!");
              ...
              ActivityOptionsCompat options = ActivityOptionsCompat
                  .makeSceneTransitionAnimation(MyActivity.this, (View)serviceCardImageView, "transition_service_card");
    ...
    private int getColorByOffset(float percent, int initColor, int targetColor) {
      ...
      int g = (int) (Color.green(initColor) + t * (Color.green(targetColor) - Color.green(initColor)) );
    ...
    private void generateData() {
      ...
      urls2.add("https://hottelling.files.wordpress.com/2014/04/hafengeburtstag-in-hamburg-mit-queen-mary-ii-foto-christian-spahrbier.jpg");
